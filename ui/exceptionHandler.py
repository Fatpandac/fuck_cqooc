...
class exceptionHandler(ttk.Toplevel):
    def __init__(self,master,e:Exception) -> None:
        ...
        self.label1 = ttk.Label(master=self,anchor=ttk.W,font=font,text="程序运行过程中出现了错误，下面是错误信息。")
        self.label2 = ttk.Label(master=self,anchor=ttk.W,font=font,text="麻烦你把下列错误信息发送到 github.com/Fatpandac/fuck_cqooc/issues。我们很快就会修复的！")
        ...
        self.stacktraceText.insert(ttk.END,"请将本段信息发送到github.com/Fatpandac/fuck_cqooc/issues，使用快捷键Ctrl+A和Ctrl+C复制。\n")
        self.stacktraceText.insert(ttk.END,"===============================================\n")
